...
def Format_Software_Not_Allowed(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Format_Software_Not_Allowed() called')
    
    template = """|  `otsec_action_check_software_not_allowed(\"{0}\")`"""
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="Format_Software_Not_Allowed")

    Check_Software_Not_Allowed(container=container)
...
"""
def Check_Software_Not_Allowed(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Check_Software_Not_Allowed() called')
        
    #phantom.debug('Action: {0} {1}'.format(action['name'], ('SUCCEEDED' if success else 'FAILED')))
    
    # collect data for 'Check_Software_Not_Allowed' call
    formatted_data_1 = phantom.get_format_data(name='Format_Software_Not_Allowed')

    parameters = []
    
    # build parameters list for 'Check_Software_Not_Allowed' call
    parameters.append({
    ...
    phantom.act(action="run query", parameters=parameters, assets=['splunk es - ot sec'], callback=filter_1, name="Check_Software_Not_Allowed")
...
def filter_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    matched_artifacts_1, matched_results_1 = phantom.condition(
        ...
        conditions=[
            ["Check_Software_Not_Allowed:action_result.summary.total_events", ">", 0],
        ],
        name="filter_1:condition_1")

    # call connected blocks if filtered artifacts or results
    if matched_artifacts_1 or matched_results_1:
        Format_Pin_Software_Not_Allowed(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
...
def Format_Pin_Software_Not_Allowed(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Format_Pin_Software_Not_Allowed() called')
    
    template = """Total {0} Records Detected for Review"""

    # parameter list for template variable replacement
    parameters = [
        "filtered-data:filter_1:condition_1:Check_Software_Not_Allowed:action_result.summary.total_events",
    ]

    phantom.format(container=container, template=template, parameters=parameters, name="Format_Pin_Software_Not_Allowed")

    Pin_Check_Software_Not_Allowed(container=container)

    return

def Pin_Check_Software_Not_Allowed(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Pin_Check_Software_Not_Allowed() called')

    formatted_data_1 = phantom.get_format_data(name='Format_Pin_Software_Not_Allowed')
...
%%"""
    ...
    # parameter list for template variable replacement
    parameters = [
        "Check_Software_Not_Allowed:action_result.data.*.process_name",
        "Check_Software_Not_Allowed:action_result.data.*.source",
    ]
...
def Search_OT_Asset(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="run query", parameters=parameters, assets=['splunk es - ot sec'], callback=Format_Software_Not_Allowed, name="Search_OT_Asset")
