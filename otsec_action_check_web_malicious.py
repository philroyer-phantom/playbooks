...
def Format_Web_Malicious_Activity(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Format_Web_Malicious_Activity() called')
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="Format_Web_Malicious_Activity")
...
def Check_Web_Malicious_Activity(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    formatted_data_1 = phantom.get_format_data(name='Format_Web_Malicious_Activity')
...
def filter_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    if matched_artifacts_1 or matched_results_1:
        Format_Pin_Web_Malicious_Activity(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
...
def Format_Pin_Web_Malicious_Activity(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Format_Pin_Web_Malicious_Activity() called')
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="Format_Pin_Web_Malicious_Activity")

    Pin_Check_Web_Malicious_Activity(container=container)

    return

def Pin_Check_Web_Malicious_Activity(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Pin_Check_Web_Malicious_Activity() called')

    formatted_data_1 = phantom.get_format_data(name='Format_Pin_Web_Malicious_Activity')

    phantom.pin(container=container, data=formatted_data_1, message="Check Web Malicious Activity", name="Check Web Malicious Activity")
...
def add_note_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    note_title = "Check Web Malicious Activity"
...
def Search_OT_Asset(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="run query", parameters=parameters, assets=['splunk es - ot sec'], callback=Format_Web_Malicious_Activity, name="Search_OT_Asset")
