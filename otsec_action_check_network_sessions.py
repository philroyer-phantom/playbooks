...
def Pin_Check_Network_Sessions(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.pin(container=container, data=formatted_data_1, message="Check for network communications that are not allowed", name="Check for network communications that are not allowed")
...
def Add_Note_Format(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    template = """**GUIDE** : Check for network communications that are not allowed for this host from the detected sessions.
...
%%"""
    ...
    # parameter list for template variable replacement
    parameters = [
        "Check_Network_Sessions:action_result.data.*.src",
        "Check_Network_Sessions:action_result.data.*.dest",
        "Check_Network_Sessions:action_result.data.*.count",
        "Check_Network_Sessions:action_result.data.*.action",
        "Check_Network_Sessions:action_result.data.*.src_port",
        "Check_Network_Sessions:action_result.data.*.dest_port",
        "Check_Network_Sessions:action_result.data.*.transport",
    ]
